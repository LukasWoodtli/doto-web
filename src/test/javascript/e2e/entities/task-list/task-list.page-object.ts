...
export class TaskListComponentsPage {
  ...
  deleteButtons = element.all(by.css('jhi-task-list div table .btn-danger'));
  title = element.all(by.css('jhi-task-list div h2#page-heading span')).first();
...
export class TaskListUpdatePage {
  pageTitle = element(by.id('jhi-task-list-heading'));
