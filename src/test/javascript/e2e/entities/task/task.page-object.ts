...
export class TaskUpdatePage {
  ...
  async listSelectLastOption(): Promise<void> {
    await this.listSelect.all(by.tagName('option')).last().click();
  }

  async listSelectOption(option: string): Promise<void> {
  ...
  async getListSelectedOption(): Promise<string> {
