...
describe('Task e2e test', () => {
  ...
  it('should load Tasks', async () => {
    ...
    expect(await taskComponentsPage.getTitle()).to.eq('dotoApp.task.home.title');
  ...
  it('should load create Task page', async () => {
    ...
    expect(await taskUpdatePage.getPageTitle()).to.eq('dotoApp.task.home.createOrEditLabel');
  ...
  it('should create and save Tasks', async () => {
    ...
    await promise.all([
      ...
      taskUpdatePage.listSelectLastOption(),
    ]);
  ...
  it('should delete last Task', async () => {
    ...
    expect(await taskDeleteDialog.getDialogTitle()).to.eq('dotoApp.task.delete.question');
