...
import info.woodtli.doto.config.audit.AuditEventConverter;
import info.woodtli.doto.domain.PersistentAuditEvent;
...
import static info.woodtli.doto.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
